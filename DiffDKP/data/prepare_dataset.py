...
def main():
    ...
    images_path = 'datasets/deblur/{}/HR_256/HR_256/*.png'.format(opt.dataset)
    out_path_im = 'datasets/deblur/{}/{}_lr_x{}'.format(opt.dataset, opt.model, opt.sf)
    out_path_ker = 'datasets/deblur/{}/{}_gt_k_x{}'.format(opt.dataset, opt.model, opt.sf)
